...
class AliOSS {
  ...
  /// 必须先初始化
  void initialize(String aliOSSAccessKeyId, String aliOSSKeySecret, {String? policyText}) {
    final String text =
        policyText ??
  ...
  Future<FormData> setFormData(String filePath, String ossPath, {MediaType? contentType, String? fileName}) async {
